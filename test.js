...
describe("geo-shapes", () => {
  ...
  describe("distance_fast", function() {
    it("should be pretty accurate within 100km", () => {
      ...
      for(const [lat_1, lon_1, lat_2, lon_2] of FAST_TEST_POINTS) {
  ...
  describe("bearing_fast", function() {
    it("should be pretty accurate within 100km", () => {
      const e = 0.1; // tenth of a degree

      for(const [lat_1, lon_1, lat_2, lon_2] of FAST_TEST_POINTS) {
        expect(geoshapes.bearing_fast(lat_1, lon_1, lat_2, lon_2)).
          to.be.closeTo(geoshapes.bearing_accurate(lat_1, lon_1, lat_2, lon_2), e);
      }
    });
  });
